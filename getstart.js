...
(async function test() {
    ...
    try {
        ...
        const  se = new Select(driver.findElement(By.xpath("/html/body/div[3]/div/div[1]/div/table/tbody/tr/td[1]/table/tbody/tr/td[6]/div")));
			
     
        se.selectByVisibleText("ABP12").click();
        await driver.findElement(document.querySelector("#ext-gen434 > div.x-combo-list-item.x-combo-selected")).click();
